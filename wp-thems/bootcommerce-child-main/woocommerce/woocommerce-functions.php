...
if (!function_exists('bs_woocommerce_breadcrumbs')) :
  ...
  function bs_woocommerce_breadcrumbs() {
    return array(
      'delimiter'   => '',
      'wrap_before' => "<nav aria-label='breadcrumb' class='wc-breadcrumb breadcrumb-scroller mb-4 mt-2 py-2 px-3 rounded'>
...
function custom_empty_cart_message() {
  $html  = '4141 <div class="cart-empty alert alert-info">';
